...
import com.example.ausias.intercibus.VeureInfoClient;
 ...
 * @version 1.0
 */
public class AdaptadorRecyclerRebudes extends RecyclerView.Adapter <AdaptadorRecyclerRebudes.ViewHolder>{
     ...
     */
    public AdaptadorRecyclerRebudes(List<Reserva> reserves) {

        this.reserves = reserves;
    }

    @Override
    public AdaptadorRecyclerRebudes.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View v = inflater.inflate(R.layout. fila_mostra_reserva, parent, false);

        AdaptadorRecyclerRebudes.ViewHolder vh = new AdaptadorRecyclerRebudes.ViewHolder(v);

        return vh;
    }

    @Override
    public void onBindViewHolder(AdaptadorRecyclerRebudes.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (id == R.id.layoutReserva) {
                ...
                Intent intent = new Intent(v.getContext(), VeureInfoClient.class);
